...
print(f"main_Speq 使用チE��イス: {device}")
...
def test(model: nn.Module, test_csv: str, wave_type: str, out_dir: str, model_path: str, prm: int = const.SR):
	...
	for mix_data, mix_name in tqdm(dataset_loader):
		...
		separate = model(mix_data)  # モチE��の適用
...
if __name__ == "__main__":
	...
	model_list = [
		"UNet"
	]  # モチE��の種顁E "UGCN", "UGCN2", "UGAT", "UGAT2", "ConvTasNet", "UNet"
	wave_types = [
		"noise_reverb",
		"reverb_only",
		"noise_only",
	...
	node_selection = NodeSelectionType.ALL  # ノ�Eド選択�E方況E(ALL, TEMPORAL)
	edge_selection = EdgeSelectionType.GRID  # エチE��選択�E方況E(RAMDOM, KNN, GRID)
	...
	for model_type in model_list:
		...
		dir_name = "Random_Dataset_VCTK_DEMAND_1ch"  # チE�EタセチE��のチE��レクトリ吁E

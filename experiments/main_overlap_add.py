...
if __name__ == "__main__":
    ...
    for model_type in model_list:
        ...
        for wave_type in wave_types:
            ...
            #     out_path=f"{const.CHECKPOINT_DIR}/{model_type}/subset_DEMAND_hoth_5dB_500msec/{out_name}.pth",
            #     batchsize=1,
            #     loss_func="SISDR",
            ...
            test(
                ...
                model_path=f"{const.CHECKPOINT_DIR}/{model_type}/subset_DEMAND_hoth_5dB_500msec/{out_name}.pth",
            )

...
if __name__ == "__main__":
    ...
    for model_type in model_list:
        ...
        if model_type == "UGCN":
            model = UGCN(n_channels=num_mic, n_classes=1, num_node=8).to(device)
            ...
            model = UGCN2(n_channels=num_mic, n_classes=1, num_node=8).to(device)

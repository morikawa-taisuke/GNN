...
if __name__ == '__main__':
    ...
    train(dataset_path=f"{const.DATASET_DIR}/subset_DEMAND_hoth_1010dB_1ch/subset_DEMAND_hoth_1010dB_05sec_1ch/noise_reverbe",
         out_path=f"{const.PTH_DIR}/URelNet/subset_DEMAND_hoth_1010dB_05sec_1ch_noise_reverbe.pth")

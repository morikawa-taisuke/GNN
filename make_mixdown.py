...
if __name__ == '__main__':
    ...
    speech_dir = f"{const.SAMPLE_DATA_DIR}/speech/subset_DEMAND/test"
    noise_dir = f"{const.SAMPLE_DATA_DIR}/noise/DEMAND"
    out_dir = f"{const.MIX_DATA_DIR}/GNN/subset_DEMAND/test"

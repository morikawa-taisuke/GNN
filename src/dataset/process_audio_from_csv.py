...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CSV縺ｫ蠕薙＞髻ｳ螢ｰ繝・・繧ｿ繧貞・逅・)
    parser.add_argument('--csv_path', type=str, help='csv繝輔ぃ繧､繝ｫ縺ｮ繝代せ')
    parser.add_argument('--speech_dir', type=str, help='speech繝・・繧ｿ縺ｮ繝・ぅ繝ｬ繧ｯ繝医Μ')
    parser.add_argument('--noise_dir', type=str, help='noise繝・・繧ｿ縺ｮ繝・ぅ繝ｬ繧ｯ繝医Μ')
    parser.add_argument('--ir_dir', type=str, help='IR縺ｮ繝・ぅ繝ｬ繧ｯ繝医Μ')
    parser.add_argument('--output_dir', type=str, help='蜃ｺ蜉帛・繝・ぅ繝ｬ繧ｯ繝医Μ')
